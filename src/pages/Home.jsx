...
<circle cx="12" cy="6" r="6" fill="#24DB78"/>
      ...
      <div className="flex flex-row space-x-6 bg-gray-200 p-2">
        ...
        <div className="flex flex-row space-x-2 bg-green-200 rounded-md">
          ...
          <button className="transition duration-500 font-bold bg-blue-600 p-2 text-white rounded-lg hover:opacity-70 w-full">
          Sign Up
          </button>
        </div>
      </div>
      ...
      <div className="flex flex-col items-center justify-center space-y-2">
        <button className="transition text-base duration-500 font-bold bg-yellow-600 p-2 text-white rounded-lg hover:opacity-70 w-full flex flex-row space-x-2 items-center justify-center" onClick={handleShare}>
          <svg
            width="20"
            height="20"
            viewBox="0 0 24 24"
